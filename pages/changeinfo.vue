      ...
      <div class="flex mt-3 flex-col w-[100%]">
        ...
        <div class="flex items-center w-[100%] flex-col">
          ...
          <Gravatar v-else alt="User Avatar" :email="authStore.userData.primaryEmail" class="bg-on-surface-high rounded-full w-[76px] h-[76px] mt-2 mb-4"/>
                ...
                <div class="mt-4">
                  <div class="text-sm text-on-surface-medium mt-1 mb-5">
                ...
                <Input tabindex=2 type="email" elevation="32" label="Dirección de e-mail" v-model="currentData.primaryEmail" placeholder="you@example.com" :disabled="loading"></Input>
