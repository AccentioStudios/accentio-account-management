...
export default {
  ...
  safelist: [
    {pattern: /material-./, variants: ['md', 'sm'],},
    {pattern: /btn-./,},
    {pattern: /on-./,},
    {pattern: /fill-./,},
  ],
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "btn-secondary-hover": "var(--btn-secondary-color-hover)",
        "btn-secondary-active": "var(--btn-secondary-color-active)",
        ...
        "material": {
          "metal": {
            ...
            32: "var(--material-metal-32dp)",
          },
          "crystal": {
            DEFAULT: "var(--material-crystal-4dp)",
            1: "var(--material-crystal-1dp)",
            2: "var(--material-crystal-2dp)",
            3: "var(--material-crystal-3dp)",
            4: "var(--material-crystal-4dp)",
            6: "var(--material-crystal-6dp)",
            8: "var(--material-crystal-8dp)",
            12: "var(--material-crystal-12dp)",
            16: "var(--material-crystal-16dp)",
            24: "var(--material-crystal-24dp)",
          },
        },
        "utility": {
          "success": {
